...
public function create(Request $request)
{
    ...
    $messages = [
        ...
        'product_reviwe.required' => 'ห้ามว่าง',
        'product_reviwe.integer' => 'ใส่ตัวเลขเท่านั้น',
        'product_reviwe.min' => 'ขั้นต่ำมากกว่า 1',
        'product_reviwe.max' => 'สูงสุดไม่เกิน 10',
    ...
    $validator = Validator::make($request->all(), [
        ...
        'product_reviwe' => 'required|integer|min:1',
    ...
    try {
        ...
        ProductModel::create([
            ...
            'product_reviwe' => $request->product_reviwe, // ฝั่งซ้ายคือชื่อใน DB, ฝั่งขวาคือชื่อจากฟอร์ม
...
public function edit($id)
    {
        try {
            ...
            if (isset($product)) {
                ...
                return view('products.edit', compact('id', 'product_name', 'product_detail', 'product_reviwe', 'product_img'));
...
public function update($id, Request $request)
{
    ...
    try {
        ...
        $product->product_reviwe = $request->product_reviwe; // แก้ตรงนี้ครับ
        $product->save();
