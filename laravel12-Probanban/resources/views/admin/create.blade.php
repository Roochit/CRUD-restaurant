...
<div class="form-group row mb-2">
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control" name="admin_name" placeholder="ชื่อ-สกุล" value="{{ old('admin_name') }}">
        @if(isset($errors))
...
<div class="form-group row mb-2">
    ...
    <div class="col-sm-6">
        <input type="email" class="form-control" name="admin_username" placeholder="Username/Email" value="{{ old('admin_username') }}">
        @if(isset($errors))
...
<div class="form-group row mb-2">
    ...
    <div class="col-sm-6">
        <input type="password" class="form-control" name="admin_password" placeholder="Password" value="{{ old('admin_password') }}">
        @if(isset($errors))
