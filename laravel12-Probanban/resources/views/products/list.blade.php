...
@section('content')
    <h3> ::Restaurants  Managements ::
        <a href="/product/adding" class="btn btn-primary btn-sm"> Add Restaurants  </a>
    </h3>
    ...
    <table class="table table-bordered table-striped table-hover">
        <thead>
            <tr class="table-info">
                ...
                <th width="5%">Pic</th>
                <th width="65%">Restaurants Name & Detail </th>
                <th width="15%" class="text-center">Review</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="right">{{ number_format($row->product_reviwe) }}/10</td>
                <td align="center">
