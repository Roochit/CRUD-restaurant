...
<div class="form-group row mb-2">
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control" name="name2" placeholder="Name2" value="{{ old('name2') }}">
        @if(isset($errors))
            @if($errors->has('name2'))
...
<div class="form-group row mb-2">
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control" name="name3" placeholder="Name3" value="{{ old('name3') }}">
        @if(isset($errors))
            @if($errors->has('name3'))
